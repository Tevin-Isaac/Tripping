...
public class DisplayHelperMapFragment extends Fragment {
        MapView mMapView;
        private GoogleMap mMap;

        @Override
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.fragment_display_helper_map, container, false);
            ...
            mMapView.getMapAsync(new OnMapReadyCallback() {
                ...
                public void onMapReady(GoogleMap googleMap) {
                    ...
                    ArrayList<Place> places = api.getHelperPlaces();
